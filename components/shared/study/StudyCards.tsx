...
export default function StudyCards({ notebookId, pageId }: StudyMaterialTabsProps) {
       ...
       <CardContent className="w-full flex flex-col items-center justify-center">
         ...
         {showNotebookModal && (
           <div className="fixed  inset-0 bg-white  flex items-center justify-center z-10 w-full ">
             <div className="bg-white p-6 rounded-lg h-full w-full overflow-y-auto max-w-xl ">
               <div className="flex flex-col gap-2 items-center justify-center"><h2 className="text-xl font-bold mb-4 text-[#94b347]">Create Study Cards</h2></div>
         ...
         {!selectedSet ? (
           ...
           <div className="space-y-2 w-full ">
             {cardSets.map((set) => (
               <div key={set.id} className="flex items-center gap-2 p-2 w-full max-w-lg mx-auto ">
                 <Button
