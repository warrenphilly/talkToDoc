...
const UploadArea = ({
  ...
  return (
    <div className="flex min-h-[480px] md:min-h-[300px] md:min-w-[300px] flex-col md:px-6 gap-2 items-start justify-center rounded-2xl w-full h-full md:h-fit pb-10 md:pb-0">
      {showUpload && (
        <motion.div
